...
def exctract_features(audio_file, output_folder):
...
def process_audio(audioFolder, outputFolder):
    ...
    for audio_file in input_folders:
        result, elapsed_time = exctract_features(audio_file, outputFolder)
...
if __name__ == "__main__":
    ...
    outputFolder = "../Data/prosody_features_resampled/"
